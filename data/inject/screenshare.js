...
function bypassRestrictions() {
    ...
    Object.defineProperty(document, "fullscreenElement", {
        get: () => document.documentElement || document.body || document.createElement('div'),
        configurable: true
    });
...
function showPopup(resolve, reject, constraints, originalGetDisplayMedia) {
    ...
    root.innerHTML = `
        <div class="np-toast">
            <div class="np-header">
                <div class="np-title">Pass Extension</div>
