...
// Function to add our Pass button left of the existing Neo Browser button
function replaceNeoBrowserButton() {
  ...
  if (neoButton && !neoButton.dataset.replaced) {
    ...
    ourBtn.innerHTML = `
      <div class="container jcc btn-align">
        <div class="t-whitespace-nowrap ng-star-inserted">
          <span>Download Pass Launcher</span>
        </div>
      </div>
    `;
    ...
    console.log('✅ Pass NeoBrowser button added left of existing Neo Browser button');
  }
}
